export default function Home () { return (
    <div style={{margin:"64px",}}>
        <p>Welcome to the Supercell Accounts Application, where you can store players tags of account from the mobile video games <b>Clash of Clans</b>, <b>Clash Royale</b>, and <b>Brawl Stars</b>; which are all made by the video game company Supercell. This project is create for the Microsoft Student Accleator NZ Programme 2023 - Software Development, by Michael Mar. </p>
